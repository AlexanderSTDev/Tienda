  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'gastos') ? 'active bg-gradient-primary' : ''; ?>" href="<?php echo BASE_URL . 'gastos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">monetization_on</i>
            </div>
            <span class="nav-link-text ms-1">Control de Gastos</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'presupuestos') ? 'active bg-gradient-primary' : ''; ?>" href="<?php echo BASE_URL . 'presupuestos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt</i>
            </div>
            <span class="nav-link-text ms-1">Control de Presupuestos</span>
          </a>
        </li>
        <li class="nav-item">
