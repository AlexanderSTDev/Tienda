...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" style="width: 100%;" id="tblPresupuesto">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Categoria</th>
...
<script src="<?php echo BASE_URL . 'assets/js/modulos/presupuestos.js'; ?>"></script>
